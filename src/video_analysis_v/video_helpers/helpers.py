...
# todo: put the source of these functions, base on examples
...
def convert_to_mjpg(color_format: ImageFormat, color_image):
    """
    Conversion of ndarray to image format used to display on the screen
    :param color_format:
    :param color_image:
    :return:
    """
